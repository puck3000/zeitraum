    ...
    <Div100vh className=''>
      <div id='wrapper' className='relative flex flex-col w-full min-h-full'>
        ...
        <footer className='mt-6 mb-12 xl:text-2xl '>
          ...
          <ul className='flex flex-wrap w-full md:justify-between lg:w-1/2 lg:m-auto '>
            ...
            <li className='w-full md:w-1/2'>
              <ul className='flex justify-center md:justify-end'>
                <li className='h-9'>
                  <svg className='p-1 mr-4 h-9' viewBox='0 0 355 75'>
                ...
                <li>
                  <svg className='p-1 h-9' viewBox='0 0 475 70'>
